...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        txtListChild.setOnCheckedChangeListener(null);

        txtListChild.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    exercises.add(buttonView.getText().toString());
                }
                else{
                    exercises.remove(buttonView.getText().toString());
                }
                txtListChild.setChecked(isChecked);
            }
        });
